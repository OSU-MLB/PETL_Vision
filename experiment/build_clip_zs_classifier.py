...
def get_clip_proj(device):
    save_path = 'pretrained_weights/imagenet_clip_proj.pkl'
...
def init_imagenet_clip(device):
    save_path = 'pretrained_weights/imagenet_clip_head.pkl'
    ...
    if os.path.exists(save_path):
        ...
        with torch.no_grad():
            zeroshot_weights = []
            for classname in tqdm(imagenet_openai_classnames):
                texts = []
                for t in imagenet_openai_template:
